...
export default function ExplorarPage({ searchParams }: { searchParams: ExplorarSearchParams }) {
  const bookingQuery = new URLSearchParams()
  if (searchParams.desde) bookingQuery.set('desde', searchParams.desde)
  if (searchParams.hasta) bookingQuery.set('hasta', searchParams.hasta)
  if (searchParams.huespedes) bookingQuery.set('huespedes', searchParams.huespedes)
  const detalleHref = (propiedad: string) => {
    const query = new URLSearchParams(bookingQuery)
    query.set('propiedad', propiedad)
    return `/detalle?${query.toString()}`
  }
          ...
          <article className="group relative flex flex-col overflow-hidden rounded-xl border border-[#434655] bg-[#131313] md:col-span-2 md:flex-row">
            ...
            <div className="relative z-10 flex w-full flex-col justify-between bg-[#131313] p-10 md:w-2/5">
              ...
              <div className="mt-auto flex flex-col gap-3">
                ...
                <TrackedLink eventName="ver_detalle_click" location="explorar_card_yeso" href={detalleHref('yeso')} className="flex items-center justify-center gap-2 rounded-lg bg-[#2d68ff] py-3 text-[16px] font-medium leading-6 text-[#fffcff] shadow-[0_4px_20px_rgba(45,104,255,0.0)] transition-all duration-300 hover:bg-[#b5c4ff] hover:text-[#00164e] hover:shadow-[0_4px_20px_rgba(45,104,255,0.3)]">
                  Ver detalle
          ...
          <article className="group relative flex flex-col overflow-hidden rounded-xl border border-[#434655] bg-[#131313]">
            ...
            <div className="flex flex-grow flex-col p-6">
              ...
              <div className="mt-auto flex items-center justify-between pt-2">
                ...
                <TrackedLink eventName="ver_detalle_click" location="explorar_card_graciana" href={detalleHref('graciana')} className="rounded-lg border border-[#434655] px-4 py-2 text-[14px] font-medium leading-5 text-[#e5e2e1] transition-colors hover:bg-[#201f1f]">
                  Ver detalle
                </TrackedLink>
              </div>
            </div>
          ...
          <article className="group relative flex flex-col overflow-hidden rounded-xl border border-[#434655] bg-[#131313]">
            ...
            <div className="flex flex-grow flex-col p-6">
              ...
              <div className="mt-auto flex items-center justify-between pt-2">
                ...
                <TrackedLink eventName="ver_detalle_click" location="explorar_card_chiquito" href={detalleHref('chiquito')} className="rounded-lg border border-[#434655] px-4 py-2 text-[14px] font-medium leading-5 text-[#e5e2e1] transition-colors hover:bg-[#201f1f]">
                  Ver detalle
                </TrackedLink>
              </div>
            </div>
          ...
          <article className="group relative flex flex-col overflow-hidden rounded-xl border border-[#434655] bg-[#131313]">
            ...
            <div className="flex flex-grow flex-col p-6">
              ...
              <div className="mt-auto flex items-center justify-between pt-2">
                ...
                <TrackedLink eventName="ver_detalle_click" location="explorar_card_maricarmen" href={detalleHref('maricarmen')} className="rounded-lg border border-[#434655] px-4 py-2 text-[14px] font-medium leading-5 text-[#e5e2e1] transition-colors hover:bg-[#201f1f]">
                  Ver detalle
                </TrackedLink>
              </div>
            </div>
